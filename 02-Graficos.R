# Capítulo 4
# Gráficos em R - Base Plotting System (importante p/a processos de análise explo.)
...
# demo
demo('graphics') #mostra as funções do pacote

# Plot Básico
x = 5:7
y = 8:10
plot(x,y) #cruza informações de 2 variáveis
?plot


altura <- c(145,167,176,123,150)
largura <- c(51,63,64,40,55)
plot(altura,largura) #cruza informações de 2 variáveis
...
plot(lynx, main = 'Plots com Dataframe', col='red', col.main = 52, cex.main= 1.5)

library(datasets)
hist(warpbreaks$breaks)

airquality
transform(airquality, Month = factor(Month)) # Fazendo uma modificação
...
?par
par() # Consultar parametros dos graficos
par('pch')
par('lty')

x=2:4
plot(x, pch='c') # pch é o valor do símbolo (pontos), pode ser o caracter que eu quiser '*' 'o'

par(mfrow = c(2,2), col.axis = "springgreen")
plot(1:8, las = 0, xlab = "xlab", ylab = "ylab", main = "LAS = 0")
plot(1:8, las = 1, xlab = "xlab", ylab = "ylab", main = "LAS = 1")
plot(1:8, las = 2, xlab = "xlab", ylab = "ylab", main = "LAS = 2")
plot(1:8, las = 3, xlab = "xlab", ylab = "ylab", main = "LAS = 3")
legend("topright", pch = 1, col = c("wheat", "turquoise2"), legend = c("Var1","Var2"))
par(mfrow = c(1,1)) # Volta a usar apenas um gráfico na área
...
# png
png("Grafico1.png", width = 500, height = 500, res = 72) # Não mostra na area de plotagem apenas grave

plot(iris$Sepal.Length, iris$Petal.Length,
     col = iris$Species,
     main = "Gráfico gerado a partir do Iris")

dev.off() # fecha para depois encontrar o arquivo no diretorio que estou trabalhando


# pdf - o mesmo feito com o png dá para ser feito com pdf
pdf("Grafico2.pdf")
...
ablineclip(v=1, lty=1, col="sienna2", lwd=2) # add linha dentro do gráfico
...
plot(lynx)
plot(lynx, type="p", main="Type p") # diferentes tipos de gráficos
...
plot(lynx, type="n", main="Type n") # limpa
...
title(main="Velocidade x Distância") #add titulo ao gráfico
