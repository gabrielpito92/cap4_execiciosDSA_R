...
dataset1_scat_out <- filter(dataset1, Country != "United States") #numero de assinantes muito alto
dataset1_bar <- filter(dataset1, Country != "Switzerland") #desigaldade social baixa
dataset1_bar_out <- filter(dataset1_bar, Country != "South Africa") #desigaldade social alta
