...
View(tips) # dataset vem junto com o R
...
?aes # função mapeamento de estetica
??aes

# Contruindo um modelo de regressão (lm)
...
# Versão final otimizada --- tudo que foi feito acima feito em um comando
...
head(mtcars)
ggplot(data = mtcars, aes(x = disp, y = mpg)) + geom_point() #correl negativa
